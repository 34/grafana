...
(function (root, factory) {
  ...
  function $translate($STORAGE_KEY, $windowProvider, $translateSanitizationProvider, pascalprechtTranslateOverrider) {
    ...
    var translations = function (langKey, translationTable) {
      console.log('-debug-translations', langKey, translationTable)
    ...
    this.$get = ['$log', '$injector', '$rootScope', '$q', function ($log, $injector, $rootScope, $q) {
      ...
      var $translate = function (translationId, interpolateParams, interpolationId, defaultTranslationText, forceLanguage, sanitizeStrategy) {
        console.log('-debug-translate', translationId, interpolateParams, interpolationId, defaultTranslationText, forceLanguage, sanitizeStrategy);
      ...
      var applyNotFoundIndicators = function (translationId) {
        console.log('-debug-applyNotFoundIndicators', translationId);
      ...
      var resolveForFallbackLanguage = function (fallbackLanguageIndex, translationId, interpolateParams, Interpolator, defaultTranslationText, sanitizeStrategy) {
        console.log('-debug-resolveForFallbackLanguage', fallbackLanguageIndex, translationId, interpolateParams, Interpolator, defaultTranslationText, sanitizeStrategy)
        var deferred = $q.defer();
        ...
        if (fallbackLanguageIndex < $fallbackLanguage.length) {
          ...
          if (defaultTranslationText) {
            ...
            if (cachedNotFoundText.indexOf(translationId) < 0) {
              $.post('/api/trans', {text: translationId}, function(data) {
                cachedNotFoundText.push(translationId);
                console.log("-debug- save not found translationId", translationId);
              });
            }
          }
        }
      ...
      var fallbackTranslation = function (translationId, interpolateParams, Interpolator, defaultTranslationText, sanitizeStrategy) {
        ...
        console.log('-debug-fallbackTranslation', translationId, interpolateParams, Interpolator, defaultTranslationText, sanitizeStrategy)
      ...
      var fallbackTranslationInstant = function (translationId, interpolateParams, Interpolator, sanitizeStrategy) {
        // Start with the fallbackLanguage with index 0
        console.log('-debug-fallbackTranslationInstant', translationId, interpolateParams, Interpolator, sanitizeStrategy)
        return resolveForFallbackLanguageInstant((startFallbackIteration > 0 ? startFallbackIteration : fallbackIndex), translationId, interpolateParams, Interpolator, sanitizeStrategy);
      };
  
      var determineTranslation = function (translationId, interpolateParams, interpolationId, defaultTranslationText, uses, sanitizeStrategy) {
        console.log('-debug-determineTranslation', translationId, interpolateParams, interpolationId, defaultTranslationText, uses, sanitizeStrategy)
        var deferred = $q.defer();
      ...
      var determineTranslationInstant = function (translationId, interpolateParams, interpolationId, uses, sanitizeStrategy) {
        console.log('-debug-determineTranslationInstant', translationId, interpolateParams, interpolationId, uses, sanitizeStrategy);
      ...
      $translate.instant = function (translationId, interpolateParams, interpolationId, forceLanguage, sanitizeStrategy) {
        console.log('-debug-instant', translationId, interpolateParams, interpolationId, forceLanguage, sanitizeStrategy)
  ...
  function translateFilterFactory($parse, $translate) {
    ...
    var translateFilter = function (translationId, interpolateParams, interpolation, forceLanguage) {
        console.log("-debug-translateFileter", translationId, interpolateParams, interpolation, forceLanguage);
